...
const nextConfig = {
  ...
  async redirects() {
    return [
        ...
        { source: "/phoenix/pest-control/mosquito-control", destination: "/phoenix-az/pest-and-termite", permanent: true },
        { source: "/phoenix/pest-control/roach-control", destination: "/phoenix-az/pest-and-termite", permanent: true },

    ...
    content: [
      ...
      },
      {
        ...
        paragraphs: [
          ...
          "Second, Tucson's monsoon season (typically late June through September) creates ideal scorpion conditions. Sudden humidity spikes drive scorpions indoors seeking shelter, while monsoon flooding pushes ground-dwelling scorpions upward and outward into homes, garages, and pool areas. The 2025 monsoon season brought multiple severe storms that triggered scorpion surges across the Tucson metro — and the 2026 monsoon season is now underway, with the first major storms already impacting the region.",

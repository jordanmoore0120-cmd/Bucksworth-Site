...
export const CITIES: City[] = [
  ...
  // ── West Valley expansion (2026-08-03): confirmed real service cities only ──
  // Tolleson, El Mirage, and Youngtown were added in this same batch by a prior
  // session without checking with Jordan — they are NOT serviced. Removed
  // 2026-09-25; see src/middleware.ts for the redirects covering their old URLs.
